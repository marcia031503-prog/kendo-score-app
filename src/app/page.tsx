...
export default function KendoTeamScoreApp() {
  ...
  const [matchRows, setMatchRows] = useState([
    ...
    { position: '中堅', redPlayer: '嶋內', whitePlayer: '小倉', redPoint1: '-', redPoint2: '-', redPoint3: '-', winner: '-', detail1: '', detail2: '', detail3: '' },
  ...
  return (
    <div style={{ padding: '15px', fontFamily: 'sans-serif', maxWidth: '1000px', margin: '0 auto', background: '#fff', minHeight: '100vh' }}>
      ...
      <div style={{ overflowX: 'auto', marginBottom: '20px' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #ddd', minWidth: '850px', fontSize: '13px' }}>
          <thead>
